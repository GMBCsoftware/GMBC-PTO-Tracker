...
- The UI now includes a `Choose Google Account` action that opens Google's account chooser and returns to the deployed PTO web app URL instead of the temporary Apps Script panel URL.
